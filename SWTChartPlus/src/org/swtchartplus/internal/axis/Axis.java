 ...
 *******************************************************************************/
package org.swtchartplus.internal.axis;
...
public class Axis implements IAxis {
    ...
    public void scrollUp(double i) {
    	...
    	/*if (isLogScaleEnabled()) {
            double digitMax = Math.log10(upper);
            double digitMin = Math.log10(lower);
            upper = Math.pow(10, digitMax + (digitMax - digitMin)+i);
            lower = Math.pow(10, digitMin + (digitMax - digitMin)+i);
    	}
    	else{*/
        lower = min + i;
        upper = max + i;
