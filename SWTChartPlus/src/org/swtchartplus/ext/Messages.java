...
public class Messages {
    ...
    public static final String ADJUST_AXIS_RANGE_GROUP = "&Auto Range...";

    /** the menu for adjust axis range */
    public static final String ADJUST_AXIS_RANGE = "&Both Axes";

    /** the menu for adjust X axis range */
    public static final String ADJUST_X_AXIS_RANGE = "&X Axis";

    /** the menu for adjust Y axis range */
    public static final String ADJUST_Y_AXIS_RANGE = "&Y Axis";

    /** the menu group for zoom in menus */
    public static final String ZOOMIN_GROUP = "Zoom &In";

    /** the menu for zoom in */
    public static final String ZOOMIN = "Zoom &In\tCtrl+Plus";
    ...
    public static final String ZOOMOUT = "Zoom &Out\tCtrl+Minus";
    ...
    /** the menu for save as txt */
    public static final String SAVE_AS_TXT = "txt";

    /** the menu for save as png */
    public static final String SAVE_AS_PNG = "png";

    /** the menu for save as pdf */
    public static final String SAVE_AS_PDF = "pdf";
    
    /** the menu for save as xls */
    public static final String SAVE_AS_XLS = "xls";
