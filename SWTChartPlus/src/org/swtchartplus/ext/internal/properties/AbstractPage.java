...
public abstract class AbstractPage extends PreferencePage {
    ...
    protected Group createGroupControl(Composite parent, String text,
        ...
        //group.setLayoutData(new GridData(GridData.BEGINNING));
    ...
    /**
     * Creates the radio box.
     * 
     * @param parent
     *            the parent to create the radio box
     * @param label
     *            the label text
     * @return {@link Button} control
     */
    protected Button createRadioBoxControl(Composite parent, String label) {
        Composite composite = new Composite(parent, SWT.NULL);
        GridData gridData = new GridData();
        gridData.horizontalSpan = 1;
        composite.setLayoutData(gridData);
